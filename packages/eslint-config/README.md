...
<p align="center">Techor's ESLint config</p>
...
<p align="center">
    ...
    <a aria-label="NPM Package" href="https://www.npmjs.com/package/eslint-config-techor">
        <picture>
            <source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/npm/dm/eslint-config-techor?color=212022&label=%20&logo=npm&style=for-the-badge">
            <source media="(prefers-color-scheme: light)" srcset="https://img.shields.io/npm/dm/eslint-config-techor?color=f6f7f8&label=%20&logo=npm&style=for-the-badge">
            <img alt="NPM package ( download / month )" src="https://img.shields.io/npm/dm/eslint-config-techor?color=f6f7f8&label=%20&logo=npm&style=for-the-badge">
        </picture>
    </a>
...
extends: techor
```
For full configuration, check out the [`eslintrc.js` source code](https://github.com/techor-dev/techor/blob/beta/packages/eslint-config/.eslintrc.js)
