...
For full configuration, check out the [configure.js](https://github.com/techor-dev/techor/blob/beta/packages/semantic-release-config/configure.js) file and [Techor's conventional commits for the release rules](https://github.com/techor-dev/techor/tree/main/packages/conventional-commits)
